...
function Navbar() {
  return (
    <div className='flex justify-between items-center fixed top-0 w-full'>
      <div className='bg-black w-6/12 py-3.5 text-white font-bold'>left</div>
      <div className='backdrop-blur-sm bg-black/75 w-full py-3.5 flex justify-around text-white font-bold  outline-none'>
        <div>
          My Story
        </div>
        <div>
      ...
      <div className='bg-black w-9/12 py-1.5 relative'>
